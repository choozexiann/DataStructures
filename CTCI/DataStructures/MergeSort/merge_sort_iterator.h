...
#ifndef MERGE_SORT_ITERATOR.H
#define MERGE_SORT_ITERATOR.H
...
void merge(T begin, T mid, T end, BT begin_buffer) {
    ...
    while (low < mid && high < end) {
        ...
        if (*low <= *high) {
            ...
            // assign value to element in begin_buffer.
...
void merge_sort_buffer(T begin, T end, BT begin_buffer) {
    ...
    merge_sort_buffer(mid, end, begin_buffer);
